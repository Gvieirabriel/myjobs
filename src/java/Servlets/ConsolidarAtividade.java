 ...
 * @author guilh
 */
@WebServlet(name = "ConsolidarAtividade", urlPatterns = {"/ConsolidarAtividade"})
public class ConsolidarAtividade extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException, ClassNotFoundException {
        ...
        else if (!request.getParameter("atv").equals("todas")) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ConsolidarAtividade.class.getName()).log(Level.SEVERE, null, ex);
