 ...
 * @author guilh
 */
@WebServlet(name = "FinalizarAtividade", urlPatterns = {"/FinalizarAtividade"})
public class FinalizarAtividade extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FinalizarAtividade.class.getName()).log(Level.SEVERE, null, ex);
